            ...
            className="flex items-center relative w-full h-[450px] md:h-[550px] lg:h-[450px] xl:h-[450px] lg:w-1/2 xl:w-5/12">
              ...
              <div className="z-10 h-5/6 lg:h-full bg-white w-5/6 my-0 mx-auto rounded-2xl flex flex-col">
                ...
                >
                  ...
                  <Descripcion titulo={"Nuestra historia"} contenido={'Hoy cuatro son los socios propietarios de EMPRESA FLORIDA S.R.L. que cuenta con 44 unidades, dos vehículos de auxilio, 99 personas entre choferes, administrativos, mecánicos, lavadores, etc. Actualmente nuestro recorrido es por el ESTE de la Provincia de Tucumán incluyendo localidades como Los Ralos, Mayo Lolita, Llona, Delfín Gallo, Florida, Alabama, La Marta, etc. hasta llegar a 7 de abril'}/>
