  ...
  return (
    <div className='px-12 xl:px-0 pt-8 bg-[#F4F6FF]'>
        <div className='max-w-7xl my-o mx-auto flex flex-col md:flex-row'>
            ...
            <span className='flex basis-1/2 bg-blue-500'>
