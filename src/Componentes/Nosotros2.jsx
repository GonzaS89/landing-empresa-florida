    ...
    <div className='flex px-8 sm:px-12 xl:px-0 py-12 nosotros-bg'>
      <div className='max-w-7xl my-0 mx-auto flex flex-col gap-12 lg:gap-12'> 
        ...
        <div className='flex flex-col md:grid md:grid-cols-2 lg:grid-cols-4 gap-4 xl:mt-24'>
            ...
            <Caract titulo={'redes sociales'} refe={''} index={3} contenido={'Tenemos presencia constante en las redes. Allí podés hacernos las consultas o las denuncias que que necesites o creas conveniente para tu comodidad'}/>
        </div>
        </div>
    </div>
  )
