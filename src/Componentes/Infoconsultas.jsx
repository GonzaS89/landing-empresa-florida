...
export const Infoconsultas = () => {
  return (
    <div className="consultas-bg py-12">
        <div className="max-w-7xl my-0 mx-auto flex flex-col gap-16 lg:px-12">
            <h1 className='text-center font-terciaria font-bold lg:text-4xl xl:text-5xl text-white px-12'>Actualizamos nuestra sección de consultas para tu comodidad</h1>
