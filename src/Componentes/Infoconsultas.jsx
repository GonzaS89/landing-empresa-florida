  ...
  return (
    <div className="consultas-bg py-12 md:px-12">
        <div className="max-w-7xl lg:my-0 lg:mx-auto flex flex-col gap-16">
            <h1 className='text-center font-terciaria font-bold md:text-3xl lg:text-4xl xl:text-5xl text-white md:px-12'>Actualizamos nuestra sección de consultas para tu comodidad</h1>
