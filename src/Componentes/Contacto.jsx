...
export const Contacto = () => {
  return (
    <div className="bg-slate-900 md:px-12 pt-12">
      <div className="max-w-7xl my-0 mx-auto flex flex-col gap-8 sm:items-center md:flex-row">
        <div className=" text-white flex flex-col gap-8 basis-1/2 px-4">
          ...
          <div className="grid grid-cols-2 sm:flex flex-col gap-8">
        ...
        <span className='flex justify-centerbasis-1/2 relative'>
          <img src={FooterPick} alt="" className='flex h-[450px] md:h-5/6 object-cover object-left-center drop-shadow-custom md:absolute bottom-0'/>
        </span>
      </div>
    </div>
  )
