    ...
    <div className="bg-slate-900 md:px-12 pt-12">
      <div className="max-w-7xl my-0 mx-auto flex flex-col gap-8 sm:items-center lg:flex-row md:items-end">
        <div className=" text-white flex flex-col gap-8 basis-1/2 px-4">
          ...
          <div className="grid grid-cols-2 lg:flex flex-col gap-16">
            ...
            <div className='flex flex-col gap-8 items-center lg:items-start'>
              <h2 className='md:text-xl lg:text-2xl uppercase text-gray-400'>Seguinos en nuestras redes</h2>
        ...
        <span className='flex justify-center basis-1/2 relative'>
          <img src={FooterPick} alt="" className='flex h-[450px] md:h-[500px] lg:h-[600px] object-cover rop-shadow-custom'/>
        </span>
      </div>
    </div>
  )
