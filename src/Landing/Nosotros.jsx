        ...
        <div className="max-w-6xl my-o mx-auto flex flex-col items-center gap-12">
          ...
          <div className="flex flex-col lg:flex-row gap-8 w-full">
            <motion.div
              ...
              className="flex relative w-full h-[450px] md:h-[550px] lg-h-full lg:w-1/2 lg:basis-1/2 xl:w-5/12 ">
            ...
            <motion.div
              ...
              className="lg:w-1/2 xl:w-7/12 rounded-2xl md:h-[500px] lg:basis-1/2 xl:basis-auto">
