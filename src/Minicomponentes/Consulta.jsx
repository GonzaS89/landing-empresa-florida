...
export const Consulta = (props) => {
  ...
  return (
    <div className={`${returnBg(props.titulo)} lg:h-[550px] flex flex-col justify-center lg:justify-evenly items-start py-6 px-12 gap-6 lg:gap-8 sm:gap-10`}>
        <h2 className={`${returnTextColor(props.titulo)} text-3xl sm:text-4xl uppercase font-bold`}>{props.titulo}</h2>
        <p className={`${returnTextColor(props.titulo)} italic lg:text-lg`}>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
