...
export const Infocontacto = (props) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center gap-2 sm:gap-4">
        ...
        <div>
        <h2 className='uppercase text-gray-400 text-center lg:text-left md:text-xl lg:text-sm xl:text-base'>{props.titulo}</h2>
        <h3 className='text-center lg:text-left md:text-2xl lg:text-sm xl:text-xl uppercase'>{props.contenido}</h3>
        </div>
        </div>
  )
}
