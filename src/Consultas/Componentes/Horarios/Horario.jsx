    ...
    return (
      <motion.div
        ...
        >
          ...
          <div className="flex items-center justify-center h-auto bg-[#f54747] basis-[30%] rounded-tl-xl rounded-bl-xl relative">
          ...
          <div className="bg-[#1B3C73] basis-[70%] rounded-tr-xl rounded-br-xl flex flex-col justify-between">
            ...
            <p className="text-center font-jockey text-lg border-t-2 border-gray-500 py-4 uppercase">precio del boleto $ {codigo}</p>
          </div>
        </div>
      </motion.div>
    );
